...
from metodos.metodosEncontrarRaices.metodosCerrados import Biseccion


class BiseccionView(BaseView):
    ...
    def build(self):
        ...
        input_frame = ttk.LabelFrame(self, text="Método de Bisección")
        ...
        ttk.Button(input_frame, text="Calcular Bisección", command=self._calculate).pack(pady=10)

        # --- TABLA DETALLADA ---
        columns = ("it", "a", "b", "xm", "fxm", "error")
        self.tree = ttk.Treeview(self, columns=columns, show="headings")

        headings = {"it": "It", "a": "Lim. Inf (a)", "b": "Lim. Sup (b)",
                    "xm": "Media (xm)", "fxm": "f(xm)", "error": "Error"}
    ...
    def _calculate(self):
        try:
            ...
            raiz, historial = Biseccion(f_str, a, b, tol)
